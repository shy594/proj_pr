...
#2、给索引
{
  path = "/ChIP_seq_2/aaSHY/pr/publicData/H3K9me3/n2/"
...
#3、跑命令
{
  ...
  cmd_13 <- paste0("TEtranscripts -t ",
                   ...
                   "--project H3K9me3 --outdir ",paste0(path,"count/"),"\n")
...
{
  #Observed
  red1 <- read.table(file = paste0(path,"count/Zfp809.cntTable"), sep = "\t", stringsAsFactors = F, header = T, row.names = 1)
  colnames(red1) <- prex
